		...
		<div class="col-sm-7 contents">
			 <h3>묻고 답하기</h3>
			   <div class="panel panel-default">
			      ...
			      <div class="panel-footer">
			         ...
			         <%	} else if (userInfo.getCharIsAdmin().equals("Y")) { %>
			         			<a href="delete.jsp?id=<%=question.getId() %>" class="btn btn-danger pull-right">삭제</a>
			         <%		}
			         		}%>
			   ...
			   %>
				...
				%>
			   <form method="post" action="rewriteanswerupdate.jsp">
			   <input class="hidden" name="qnaid" value="<%=question.getId()%>">
			    <div class="panel panel-default">
				<table class="table ">
					<tbody>
						<tr>
						...
						<tr>
			               <td colspan="6"><textarea rows="3" class="form-control" name="content"><%=questionAnswer.getContent() %></textarea></td>
			            </tr>
					</tbody>
				</table>
				 <div class="panel-footer text-center">
					<button type="submit" class="btn btn-info">수정</button>
					<a href="detail.jsp?id=<%=questionAnswer.getQuestionId() %>" class="btn btn-danger">취소</a>
			    </div>
